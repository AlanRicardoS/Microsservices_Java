package com.alan.pagamento.controller;

import com.alan.pagamento.data.vo.VendaVO;
import com.alan.pagamento.service.VendaSerivce;
...
public class VendaController {
  ...
  private final VendaSerivce vendaSerivce;
  private final PagedResourcesAssembler<VendaVO> assembler;

  @Autowired
  public VendaController(VendaSerivce vendaSerivce, PagedResourcesAssembler<VendaVO> assembler) {
    this.vendaSerivce = vendaSerivce;
  ...
  public VendaVO findById(@PathVariable("id") Long id) {
    VendaVO vendaVO = vendaSerivce.findById(id);
  ...
  public ResponseEntity<?> findAll(
    ...
    Page<VendaVO> vendas = vendaSerivce.findAll(pageable);
    vendas.stream()
        .forEach(
  ...
  public VendaVO create(@RequestBody VendaVO vendaVO) {
    VendaVO proVo = vendaSerivce.create(vendaVO);
